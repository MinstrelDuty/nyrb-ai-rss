...
【最高指令】：本文篇幅较短，总字数必须控制在 600-700 字左右！语言必须极度清晰、凝练、犀利。严禁以“想象一下”等呆板词汇开头。
...
【正文】
### 📰 核心脉络
（约300字）语言要极具可读性，像讲故事一样梳理文章逻辑，必须精准嵌入2-3个核心细节（如关键史实、概念或人物）。针对长文需提炼核心冲突；针对短评(In Brief)需整合其关键论断；针对专栏(NB)需捕捉其核心机锋。
